...
namespace NOLoader.Core.Interop
{
    ...
    public static class ModAssemblyCache
    {
        ...
        public static void Build(string loaderRoot, string gameRoot)
        {
            ...
            _built = true;
            IndexAll(loaderRoot, gameRoot);
        }

        public static void Rebuild(string loaderRoot, string gameRoot)
        {
            BySimpleName.Clear();
            _built = true;
            IndexAll(loaderRoot, gameRoot);
        ...
        private static void IndexAll(string loaderRoot, string gameRoot)
        {
